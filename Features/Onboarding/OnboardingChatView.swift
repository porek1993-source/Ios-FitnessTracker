...
// Agilní Fitness Trenér — Konverzační onboarding s AI trenérem iKorbou
...
struct OnboardingChatView: View {
        ...
        ZStack {
            ...
            VStack(spacing: 24) {
                ...
                VStack(spacing: 8) {
                    ...
                    Text("iKorba má vše co potřebuje.\nJdeme na to!")
                        .font(.system(size: 16))
    ...
    /// Rough estimate of how many data fields iKorba has collected
